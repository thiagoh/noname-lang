...
SRC= noname.flex
CSRC= 
CGEN= noname-lex.cc noname-parse.cc src/noname-types.cc src/noname-ast-context.cc src/noname-function-def-node.cc src/noname-main.cc src/lexer-utilities.cc
LIBS=
CFIL= ${CSRC} ${CGEN}
LSRC= Makefile
OBJS= ${CFIL:.cc=.o}
