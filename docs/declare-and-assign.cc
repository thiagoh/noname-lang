/**
  ...
  */
AllocaInst* ptr_my_voidp_variable_not_defined = new AllocaInst(PointerTy_8, "my_voidp_variable_not_defined", label_entry);
...
CastInst* ptr_40 = new BitCastInst(ptr_int_v, PointerTy_8, "", label_entry);
